...
<body>
	...
	<div id="content-wrap">
	  <div id="main">
      <h2 style="font-size:2em;" class="style3"><b><span class="style2"><em>Tenant Customization Application:</em></span><br />
          </b></h2>
          <p style="font-size:2em;">&nbsp;</p>
          <h4><strong>Please select the customization layer category:</strong></h4>
      <br/>
          
    	<!-- main ends -->	
          <asp:Button ID="BtnDBCustomize" runat="server" Text="Database Customization Layer" 
              class="button"  Width=100% onclick="BtnDBCustomize_Click" 
              CssClass="style4" Font-Names="Arial Black" Font-Size="Small" 
              BackColor="#33CC33"/>
          <br />
          <br />
          <asp:Button ID="BtnWfCustomize" runat="server" Text="Workflow Customization Layer" 
              class="button" onclick="BtnWfCustomize_Click" Width=100% CssClass="style4" 
