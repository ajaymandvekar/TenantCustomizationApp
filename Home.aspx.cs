...
public partial class Home : System.Web.UI.Page
{
    ...
    protected void BtnWfCustomize_Click(object sender, EventArgs e)
    {
        Response.Redirect("WorkflowLayerCode/WorkflowHome.aspx");
    }
    protected void BtnDBCustomize_Click(object sender, EventArgs e)
    {
        Response.Redirect("DatabaseLayerCode/DatabaseLayer.aspx");
    }
}